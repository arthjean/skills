...
- [ ] Given un chemin canonique existant non possédé portant le même nom, when son contenu est identique ou différent, then l'installation ne le revendique ni ne l'écrase et indique d'utiliser `adopt` ou de résoudre le conflit.
